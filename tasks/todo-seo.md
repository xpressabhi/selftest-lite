...
**Acceptance criteria:**
- [x] `/test`, `/results`, `/history`, `/bookmarks`, `/profile`, `/admin` produce no canonical and no `og:url`
- [x] Indexable pages unchanged (self-canonical + x-default still present)
- [x] Tests cover prefix matching and query strings
**Verification:**
- [x] Tests pass: `npm run test -- seo`
- [x] Manual check: preview HTML of `/test` and `/about`
**Dependencies:** None
...
**Acceptance criteria:**
- [x] Named bots allowed, app paths still disallowed for `*`
- [x] File stays valid robots.txt
**Verification:**
- [x] Manual check: `curl` preview `/robots.txt`
**Dependencies:** None
...
**Acceptance criteria:**
- [x] 80 exams + 8 posts + core pages listed with absolute URLs
- [x] Route prerenders; builder has no SvelteKit imports
**Verification:**
- [x] Tests pass: `npm run test -- llms`
**Dependencies:** None
...
**Acceptance criteria:**
- [x] No fabricated dates; blog dates real
- [x] URL count unchanged (96)
**Verification:**
- [x] Tests pass: `npm run test`
- [x] Manual check: preview `/sitemap.xml`
**Dependencies:** None
...
**Acceptance criteria:**
- [x] Present on all pages; absolute or root-relative valid
**Verification:**
- [x] Manual check: preview head of `/` and `/blog`
**Dependencies:** None
...
**Acceptance criteria:**
- [x] HTML navigations prefer network; offline still serves cached page
- [x] No other cache rules changed
**Verification:**
- [x] `npm run check`; manual check offline toggle in preview
**Dependencies:** None
...
**Acceptance criteria:**
- [x] Checklist is actionable by a non-engineer
...
**Acceptance criteria:**
- [x] hreflang pairs reciprocal for every twin route
- [x] App paths produce `languageHref === null`
- [x] No page hardcodes the origin after this phase
**Verification:**
- [x] Tests pass: `npm run test -- seo`
**Dependencies:** Task 1
...
**Acceptance criteria:**
- [x] Rendered head byte-equal except ordered/duplicate tags
- [x] No behaviour change in JSON-LD types
**Verification:**
- [x] `npm run test`, `npm run check`
**Dependencies:** Task 8
...
**Acceptance criteria:**
- [x] FAQ has no canonical change; legal pages unchanged
**Verification:**
- [x] `npm run test`, `npm run check`
**Dependencies:** Task 8
...
**Acceptance criteria:**
- [x] Build output contains static HTML for each; home stays SSR
- [x] 404 for unknown blog slug still works
**Verification:**
- [x] `npm run check`; inspect `.vercel/output/static`
...
**Acceptance criteria:**
- [x] Covers home, hub, exam, blog index, blog post, faq, noindex page
- [x] Fails if canonical disappears
**Verification:**
- [x] `npm run smoke`
...
- [x] `npm run check` + full suite pass
- [x] Prerendered HTML inspected manually
...
**Acceptance criteria:**
- [x] Every unique syllabus unit + stream has a Hindi string
- [x] Acronyms (exam ids/names) untouched
**Verification:**
- [x] `npm run test -- indianExams` (new test file)
**Dependencies:** None
...
**Acceptance criteria:**
- [x] English pages visually and structurally unchanged (e2e passes)
**Verification:**
- [x] `npm run smoke`
...
**Acceptance criteria:**
- [x] English pages unchanged (e2e passes)
**Verification:**
- [x] `npm run smoke`
...
**Acceptance criteria:**
- [x] Planner/chat behaviour unchanged (smoke test home passes)
**Verification:**
- [x] `npm run smoke`
...
**Acceptance criteria:**
- [x] `/hi/*` SSR emits `<html lang="hi">` and Hindi store value
- [x] App pages keep preference behaviour
**Verification:**
- [x] `npm run test` + preview HTML check
...
**Acceptance criteria:**
- [x] `/hi`, `/hi/practice`, 80 `/hi/practice/*`, `/hi/blog`, 8 posts, static pages render Hindi
- [x] Toggle on `/hi/*` goes to English twin and vice versa; app pages still flip store
- [x] No English page links to `/hi` except hreflang/language toggle
**Verification:**
- [x] `npm run smoke` + manual browser check
...
**Acceptance criteria:**
- [x] Every indexable URL appears with reciprocal alternates
- [x] Build output contains `/hi` prerendered pages
**Verification:**
- [x] `npm run test`, `npm run check`
...
**Acceptance criteria:**
- [x] Every indexable English route has a Hindi twin assertion
- [x] Full suite green
**Verification:**
- [x] `npm run lint && npm run test && npm run smoke`
...
- [x] Manual check: `/hi` language toggle round-trip on mobile viewport
- [x] Review with human before merge
