...
4. Do NOT place any ads until AdSense gives you the code snippet. When ready, add the AdSense script to `src/app.html` inside the `<head>`.

How to add AdSense script (example)
1. After you get your AdSense code, add it to `src/app.html` inside the `<head>`. Keep it commented until you're ready to show ads.
